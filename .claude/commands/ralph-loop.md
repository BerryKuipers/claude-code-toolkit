...
echo "  - Makes decisions and continues without user input"
echo "  - Only stops if BLOCKED by critical error"
echo ""
...
echo "  2. Run: $STORY_EXECUTOR with story context AND 'AUTONOMOUS MODE: true'"
echo "  3. Wait for executor to complete"
echo "  4. Update state files (prd.json, progress.txt)"
echo "  5. ALWAYS run /clear after EACH story (don't wait for 75%)"
echo ""
