...
from .base_llm_client import AVAILABLE_MODELS, LLMClientFactory, ModelInfo, LLMProvider
...
def _render_model_info(model: ModelInfo):
    ...
    st.markdown(f"• Function calling: {'✅' if model.supports_function_calling else '❌'}")
