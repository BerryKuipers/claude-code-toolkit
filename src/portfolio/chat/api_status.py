...
class APIStatusChecker:
    ...
    def check_openai_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = requests.get(
                "https://status.openai.com/api/v2/status.json", timeout=5
            )
    ...
    def _cache_result(self, cache_key: str, data: Dict[str, Any]):
        ...
        self.status_cache[cache_key] = {"data": data, "timestamp": datetime.now()}
    ...
    def render_status_widget(self):
        ...
        with col1:
            ...
            st.markdown(
                f"{status_color} **Status:** {anthropic_status['status'].title()}"
            )
