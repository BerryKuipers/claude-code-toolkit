...
try:
    ...
    for balance in significant_balances:
        print(f"{balance['symbol']:>8}: {balance['total']:>15.8f} (Available: {balance['available']:>12.8f}, In Orders: {balance['in_order']:>12.8f})")
    ...
    print("- Differences can occur if you have deposits/withdrawals not captured in trade history")
