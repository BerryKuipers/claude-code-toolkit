...
def _make_trade(side: str, amount: str, price: str, fee: str = "0", ts: int = None) -> Dict[str, str]:
...
class TestFIFOCalculation:
    ...
    def test_full_lot_sell(self):
        ...
        assert pnl["realised_eur"] == Decimal("48")  # (150-1) - (100+1) = 149 - 101 = 48
...
class TestAPIHelpers:
    ...
    def test_get_portfolio_assets(self, mocker):
        ...
        mock_client.balance.return_value = [
            ...
            {"symbol": "ADA-EUR", "available": "0", "inOrder": "0"},  # Should be filtered out
        ]
