...
from src.portfolio.cli import app, _parse_price_override, _get_bitvavo_client
...
class TestReportCommand:
    ...
    def test_report_default_assets(self, mock_generate, mock_get_assets, mock_get_client):
...
class TestWhatIfCommand:
    ...
    def test_whatif_multiple_assets(self, mock_generate, mock_get_client):
        ...
        assert result.exit_code == 0
        expected_override = {"BTC": Decimal("35000")}
        mock_generate.assert_called_once_with(mock_client, ["BTC", "ETH"], expected_override)
